export const allCourses = {
  1: {
    ...
    transcripts: {
      "What is Generative AI?": [
        { timestamp: "0:00", text: "Welcome to the Generative AI course. Let's dive into this exciting topic." },
        { timestamp: "0:15", text: "Generative AI is a field that focuses on creating new content, like text, images, and video." },
        { timestamp: "0:30", text: "It's different from traditional AI, which is often used for classification or prediction." }
      ],
      "Understanding Foundation Models": [
        { timestamp: "0:00", text: "Foundation models are the core of modern generative AI." },
        { timestamp: "0:10", text: "These large models are pre-trained on a massive amount of data." },
